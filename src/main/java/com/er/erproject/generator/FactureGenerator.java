...
public class FactureGenerator {
    ...
    public FactureGenerator(Offre offre, VentillationModel ventillation,BonCommande bc,String condition,String responsable,String fonction,HttpServletRequest servletRequest) throws Exception {
        this.setOffre(offre);
...
//            TacheModel tache = this.offre.getTacheinitials().getTravaux().get(i);
        ...
        addEmptyLine(information,1);
        information.add(new Phrase(this.fonction,smallFont));
        addEmptyLine(information,6);
        information.add(new Phrase(this.responsable,smallFontBold));
