...
public class FactureGenerator {
    ...
    public FactureGenerator(Offre offre, VentillationModel ventillation,BonCommande bc,String condition,String responsable,HttpServletRequest servletRequest) throws Exception {
        this.setOffre(offre);
