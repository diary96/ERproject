 ...
 * @author diary
 */
public class FactureTSGenerator {
    private Offre offre;
...
//        c1.setBackgroundColor(myColorpan);
        ...
        taches = offre.getTacheSupplementaire().getTravaux();
...
//            TacheModel tache = this.offre.getTacheinitials().getTravaux().get(i);
        ...
        c1 = new PdfPCell(new Phrase(UtilConvert.toMoney(offre.getStatTS().getTotalEffectuer()), smallFont));
        c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
        c1.setVerticalAlignment(Element.ALIGN_MIDDLE);
        table.addCell(c1);
        ...
        if(offre.getSoumission().getRemise()!=0){
            ...
            c1 = new PdfPCell(new Phrase("REMISE " + offre.getStatTS().getRemise() + " %", boldFont));
            c1.setColspan(2);
            c1.setBorder(Rectangle.NO_BORDER);
            c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
            c1.setVerticalAlignment(Element.ALIGN_MIDDLE);
            ...
            c1 = new PdfPCell(new Phrase(UtilConvert.toMoney(offre.getStatTS().getValeurRemise()), smallFont));
            c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
            c1.setVerticalAlignment(Element.ALIGN_MIDDLE);
            table.addCell(c1);
        ...
        c1 = new PdfPCell(new Phrase("TVA "+offre.getStatTS().getTva()+"%", boldFont));
        c1.setColspan(2);
        c1.setBorder(Rectangle.NO_BORDER);
        c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
        c1.setVerticalAlignment(Element.ALIGN_MIDDLE);
        ...
        c1 = new PdfPCell(new Phrase(UtilConvert.toMoney(offre.getStatTS().getValeurTVA()), smallFont));
        c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
        c1.setVerticalAlignment(Element.ALIGN_MIDDLE);
        table.addCell(c1);
        ...
        c1 = new PdfPCell(new Phrase(UtilConvert.toMoney(offre.getStatTS().getTotalTTC()), smallFont));
        c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
        c1.setVerticalAlignment(Element.ALIGN_MIDDLE);
        table.addCell(c1);
        ...
        if(ventillation.getPourcentage()!=100){
            ...
            c1 = new PdfPCell(new Phrase(UtilConvert.toMoney(NumberUtil.pourcentage(offre.getStatTS().getTotalTTC(),ventillation.getPourcentage())), smallFont));
            c1.setHorizontalAlignment(Element.ALIGN_RIGHT);
            c1.setVerticalAlignment(Element.ALIGN_MIDDLE);
            table.addCell(c1);
        }
