 ...
 * @author diary
 */
public class FactureTsPdfGenerator {
    /*
 * To change this license header, choose License Headers in Project Properties.
 * To change this template file, choose Tools | Templates
 * and open the template in the editor.
 ...
 */
    ...
    private String FILE = PathData.PATH_PDF_FACTURE_TS_LISTE;
    ...
    private List<VentillationTS> ventillations;
    ...
    public FactureTsPdfGenerator() {
    }

    public List<VentillationTS> getVentillations() {
        return ventillations;
    }

    public void setVentillations(List<VentillationTS> ventillations) {
    ...
    private void createTable(Document document) throws Exception {
        ...
        for (int i = 0; i < ventillations.size(); i++) {
            VentillationTS ventilation = ventillations.get(i);
            ...
            c1 = new PdfPCell(new Phrase(ventilation.getTravauxSupplementaire().getOffre().getTicket(), smallFont));
            c1.setHorizontalAlignment(Element.ALIGN_LEFT);
            table.addCell(c1);

            c1 = new PdfPCell(new Phrase(ventilation.getTravauxSupplementaire().getOffre().getNomProjet(), smallFont));
            c1.setHorizontalAlignment(Element.ALIGN_LEFT);
            table.addCell(c1);
    ...
    public FactureTsPdfGenerator(List<VentillationTS> ventillation,HttpServletRequest requestServlet) throws Exception {
