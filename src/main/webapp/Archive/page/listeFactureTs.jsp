...
<!--                      <li><a class="close-link"><i class="fa fa-close"></i></a>-->
                  ...
                  <div class="x_content">
                      <form action="listeFacturationTs" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" methode="GET">
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                          <s:iterator value="ventillationsTsData" status="ventilation">
                        ...
                        <ul  class="pagination pagination-lg pager">
                            ...
                            <s:iterator begin="1" end="%{parameter.getMax()}" status="statu">
                                <s:if test="%{#statu.index == parameter.getPage()-1}">
                                    <%@include file="template/default/pagination/facturationTs/pagenumberActive.jsp" %>
                                </s:if>
                                <s:else>
                                    <%@include file="template/default/pagination/facturationTs/pagenumber.jsp" %>
                                </s:else>
