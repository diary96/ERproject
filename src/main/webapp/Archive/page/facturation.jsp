            ...
            <div class="x_panel">
                <div class="row tile_count">
                    <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
                        ...
                        <div class="count"><s:property value="getOffre().getStatInitial().getTotalEffectuer()"/></div>             
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
                        ...
                        <div class="count"><s:property value="getOffre().getStatInitial().getValeurTVA()"/></div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
                        ...
                        <div class="count"><s:property value="getOffre().getStatInitial().getValeurRemise()"/></div>
                    </div>

                    <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
                        <span class="count_top"><i class="fa fa-money"></i> Total TTC</span>
                        <div class="count"><s:property value="getOffre().getStatInitial().getTotalTTC()"/></div>
                    </div>
